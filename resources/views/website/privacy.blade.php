            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p>The terms &ldquo;Our School&rdquo; individually and collectively refer to St. Ninians High School For Girls and the terms &ldquo;You&rdquo; /&rdquo;Your&rdquo; / &ldquo;Yourself&rdquo; refer to the users.<br />
                        ...
                        <br />
                        This Privacy Policy is a legally binding document between you and St. Ninians High School For Girls (both terms defined below). The terms of this Privacy Policy will be effective upon your acceptance of the same (directly or indirectly in electronic form, by clicking on the I accept tab or by use of the website or by other means) and will govern the relationship between you and St. Ninians High School For Girls for your use of the website St. Ninians High School For Girls.com (defined below).<br />
                        <br />
                        ...
                        <p>To improve the responsiveness of the sites for our users, we may use &ldquo;cookies&rdquo;, or similar electronic tools to collect information to assign each visitor a unique, random number as a User Identification (User ID) to understand the user&rsquo;s individual interests using the Identified Computer. Unless you voluntarily identify yourself (through registration, for example), we will have no way of knowing who you are, even if we assign a cookie to your computer. The only personal information a cookie can contain is information you supply (an example of this is when you ask for our Personalised Horoscope). A cookie cannot read data off your hard drive. Our advertisers may also assign their own cookies to your browser (if you click on their ads), a process that we do not control.<br />
                        <br />
                        Our web servers automatically collect limited information about your computer&rsquo;s connection to the Internet, including your IP address, when you visit our site. (Your IP address is a number that lets computers attached to the Internet know where to send you data &mdash; such as the web pages you view.) Your IP address does not identify you personally. We use this information to deliver our web pages to you upon request, to tailor our site to the interests of our users, to measure traffic within our site and let advertisers know the geographic locations from where our visitors come.</p>
