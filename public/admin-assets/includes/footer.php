<footer class="footer">&copy; Copyright and All Reserved by TRAP & Sandipan Dev</footer>
            ...
            <div class="modal-body">
                ...
                <div id="content-scroll" class="content">
                    ...
                    <ul class="img-gallery-thumb">
                        <li>
                            <div class="custom-check">
                                <input type="checkbox" id="c1" name="cc1" /><label for="c1"><span></span><img src="images/thumb-1.jpg" alt="" /></label>
                            </div>
                        </li>
                        <li>
                            <div class="custom-check">
                                <input type="checkbox" id="c2" name="cc2" /><label for="c2"><span></span><img src="images/thumb-2.jpg" alt="" /></label>
                            </div>
                        </li>
                        <li>
                            <div class="custom-check">
                                <input type="checkbox" id="c3" name="cc3" /><label for="c3"><span></span><img src="images/thumb-3.jpg" alt="" /></label>
                            </div>
                        </li>
                        <li>
                            <div class="custom-check">
                                <input type="checkbox" id="c4" name="cc4" /><label for="c4"><span></span><img src="images/thumb-4.jpg" alt="" /></label>
                            </div>
                        </li>
                        <li>
                            <div class="custom-check">
                                <input type="checkbox" id="c5" name="cc5" /><label for="c5"><span></span><img src="images/thumb-5.jpg" alt="" /></label>
                            </div>
                        </li>
                        <li>
                            <div class="custom-check">
                                <input type="checkbox" id="c6" name="cc6" /><label for="c6"><span></span><img src="images/thumb-6.jpg" alt="" /></label>
                            </div>
                        </li>
                    </ul>
                    ...
                    <ul class="img-gallery-thumb">
                        <li>
                            <div class="custom-check">
                                <input type="radio" id="r4" name="rr1" /><label for="r4"><span></span><img src="images/thumb-1.jpg" alt="" /></label>
                            </div>
                        </li>
                        <li>
                            <div class="custom-check">
                                <input type="radio" id="r5" name="rr1" /><label for="r5"><span></span><img src="images/thumb-2.jpg" alt="" /></label>
                            </div>
                        </li>
                        <li>
                            <div class="custom-check">
                                <input type="radio" id="r6" name="rr1" /><label for="r6"><span></span><img src="images/thumb-3.jpg" alt="" /></label>
                            </div>
                        </li>
                        <li>
                            <div class="custom-check">
                                <input type="radio" id="r7" name="rr1" /><label for="r7"><span></span><img src="images/thumb-4.jpg" alt="" /></label>
                            </div>
                        </li>
                        <li>
                            <div class="custom-check">
                                <input type="radio" id="r8" name="rr1" /><label for="r8"><span></span><img src="images/thumb-5.jpg" alt="" /></label>
                            </div>
                        </li>
                        <li>
                            <div class="custom-check">
                                <input type="radio" id="r9" name="rr1" /><label for="r9"><span></span><img src="images/thumb-6.jpg" alt="" /></label>
                            </div>
                        </li>
                    </ul>
                </div>
...
<script language="javascript" src="js/jquery.pwdMeter.js"></script>
